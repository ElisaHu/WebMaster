...
Enter this into your terminal/cmd line once you are in the proper directory (follow quick-start-guide with the following changes instead when launching dev server
)
```
